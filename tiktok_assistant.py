...
def build_yaml_prompt(video_files: List[str], analyses: List[str]) -> str:
    ...
    lines = [
        ...
        "- Each clip text should describe only what is visibly happening in that clip.",
        "- Do NOT invent comparisons between clips.",
        "- Do NOT imply one subject has more freedom, power, quality, or emotion than another unless clearly visible.",
        "- Avoid storyteller language at this stage; YAML is factual input, not final marketing copy.",
        "",
        "======================================",
